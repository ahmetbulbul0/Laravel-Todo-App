<template>
    <div>
        <div class="header">
            ...
            <div class="select">
                <select v-model="sortingValue" @change="$emit('sorting', sortingValue)">
                    ...
                    <option value="isCompleted09" :selected="sortingValue.value == 'isCompleted09'">First Incomplete
                        Todo's
                    </option>
                    <option value="isCompleted90" :selected="sortingValue.value == 'isCompleted90'">First Completed
                        Todo's
                    </option>
        ...
        <div class="header">
            ...
            <div class="text">
                <input type="text" placeholder="Search in todos..." v-model="search"
